...
public class QQMusicCrawler2 {
	...
	public static Map<String,List<String>> url1(String word,int p) {
		...
		String url1 = "https://c.y.qq.com/soso/fcgi-bin/client_search_cp?ct=24&qqmusic_ver=1298&new_json=1&"
+"remoteplace=txt.yqq.song&searchid=62442545277463100&t=0&aggr=1&cr=1&catZhida=1&"
+"lossless=0&flag_qc=0&p="+p+"&n=20&w="+word.replaceAll("\\s*", "")+"&g_tk=5381&"
+"jsonpCallback=MusicJsonCallback18054673446867553&loginUin=0&hostUin=0&format=jsonp&inCharset=utf8&outCharset=utf-8&notice=0&platform=yqq&needNewCode=0";
		try {
			//1.请求网页
			...
			//String jsonMusic = pageBuffer.toString();
			//line = jsonMusic.split("\\(")[1];
			//System.out.println(line);
			//line = line.substring(0, line.length()-1);
			line = pageBuffer.toString().substring(35, pageBuffer.toString().length()-1);
			System.out.println(line);
